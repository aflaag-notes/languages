...
\begin{document}
    ...
    \begin{example}[Semantica operazionale di $Exp$]
        ...
        $$\forall v, v' \in \mathrm{Val}, x \in \mathrm{Var} \quad [let] \ \dfrac{\opjud{E}{M}{v'} \quad \opjud{E\{(x, v')\}}{N}{v}}{\opjud{E}{\letin{x}{M}{N}}{v}}$$
    \end{example}
    ...
    \begin{example}[Equivalenze operazionali su $Exp$]
        Sia $Exp$ la grammatica definita all'interno dell'\cref{exp2}, e siano $$\centeredsoe{A := \letin{x}{(\letin{y}{M}{N})}{L} \\ B := \letin{y}{M}{(\letin{x}{N}{L})}}$$ due espressioni di $Exp$. Si noti che è possibile riscrivere $A$ come segue: $$\dfrac{\dfrac{\opjud{E}{M}{v'''} \quad \opjud{E\{(x, v''')\}}{N}{v''}}{\opjud{E}{\letin{x}{(\letin{y}{M}{N})}{L}}{v''}} \quad \opjud{E\{(x, v'')\}}{L}{v}}{\opjud{E}{A}{v}}$$ con l'ipotesi per cui $y$ sia una variabile legata TODO.
    \end{example}
