...
\begin{document}
    ...
    \begin{framedobs}{$Exp$ lazy}
        ...
        \begin{itemize}
            ...
            \item $\forall x \in \mathrm{Var}, M, N \in Exp \quad [let] \ \dfrac{\opjud{E\{(x, M)\}}{N}{v}}{\opjud{E}{\letin{x}{M}{N}}{v}}$
        \end{itemize}
    \end{framedobs}
    ...
    \begin{example}[Valutazione lazy su $Exp$]
        Si consideri l'espressione dell'\cref{eager2}; essa, valutata attraverso valutazione lazy, produce il seguente albero di derivazione: TODO
