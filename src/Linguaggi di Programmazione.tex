...
\begin{document}
    ...
    \begin{framedprop}{$Exp_\mathrm{LD}$}
        ...
        \begin{itemize}
            ...
            \item \tbf{valutazioni}: $$x \in \dom(E) \land M := E(x) \implies [vars] \ \dfrac{\opjud{E}{M}{v}}{\opjud{E}{x}{v}}$$
    ...
    \begin{framedprop}[breakable]{$Exp_\mathrm{LS}$}
        ...
        \begin{itemize}
            ...
            \item \tbf{valutazioni}: $$x \in \dom(E) \land (M, E') := E(x) \implies [vars] \ \dfrac{\opjud{E'}{M}{v}}{\opjud{E}{x}{v}}$$
    ...
    \begin{framedprop}[label={sys f1 rules}]{Regole di inferenza di \tit{System F1}}
        ...
        \begin{itemize}
            ...
            \item \tbf{variabili}: $$\exists v \in Types \mid \Gamma(x) = A \implies [vars] \ \typejud{\Gamma}{x}{A}$$
    ...
    \begin{framedprop}[breakable]{Regole di inferenza di $Fun_\tau$}
        ...
        \begin{itemize}
            ...
            \item \tbf{specializzazioni}: $$\sigma > \sigma ' \implies \dfrac{\typejud{\Gamma}{M}{\sigma}}{\typejud{\Gamma}{M}{\sigma'}}$$
