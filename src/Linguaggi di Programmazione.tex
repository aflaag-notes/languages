...
\begin{document}
    ...
    \begin{example}[Semantica operazionale di $Imp$]
        ...
        $$\forall x \in \mathrm{Var} \quad \exists v \in \mathrm{Val} \mid S(E(x)) = v \implies [vars] \ \opjudstore{E}{x}{S}{v}$$
    ...
    \begin{example}
        ...
        $$\forall x \in \mathrm{Var} \quad \exists l \in \mathrm{Loc}^+ \mid E(x) = l \implies [loc_1] \ \opjudstore[V]{E}{x}{S}{l}$$
        \centeredeq{0.9}{$\forall n \in \N, x \in \mathrm{Var} \quad \exists l_0, \ldots, l_n \in \mathrm{Loc}^+ \mid E(x) = \abk{l_0, \ldots, l_n} \implies \forall m \in [0, n] \quad [loc_2] \ \dfrac{\opjudstore[M]{E}{M}{S}{m}}{\opjudstore[V]{E}{x[M]}{S}{l_m}}$}
        $$\forall V \in LExp, l \in \mathrm{Loc} \quad \exists v \in \mathrm{Val} \mid S(l) = v \implies [ref] \ \dfrac{\opjudstore[V]{E}{V}{S}{l}}{\opjudstore[M]{E}{V}{S}{v}}$$
    \end{example}
