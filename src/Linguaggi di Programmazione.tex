...
\begin{document}
    ...
    \begin{frameddefn}{Funzione nullaria}
        Con \tbf{funzione nullaria} si intende una qualsiasi funzione della forma $$\func{f}{\1}{A}$$ per qualche insieme A.
    \end{frameddefn}

    \begin{framedobs}[label={inj null}]{Iniettività della funzione nullaria}
        Si noti che ogni funzione nullaria è sempre iniettiva, poiché il dominio è costituito da un solo elemento.
    \end{framedobs}
    ...
    \begin{framedobs}{Semantica operazionale di $Exp$}
        Sia $Exp$ la grammatica definita nell'\cref{exp2} TODO
    \end{framedobs}
