...
\begin{document}
    ...
    \begin{framedprop}[label={regole system F}]{Regole di inferenza di \tit{System F}}
        ...
        \begin{itemize}
            \item \tbf{regola della generalizzazione}: \centeredeq{0.9}{$\forall M \in Terms, A \in Types \quad \exists X \in TypeVar \mid X \notin \mathrm{free}(\Gamma) \implies [gen] \ \dfrac{\typejud{\Gamma}{M}{A}}{\typejud{\Gamma}{\Lambda X.M}{\forall X.A}}$}
            \item \tbf{regola della specializzazione}: $$\forall M \in Terms, A, B \in Types, X \in TypeVar \quad [spec] \ \dfrac{\typejud{\Gamma}{M}{\forall X.A}}{\typejud{\Gamma}{MB}{A[B/X]}}$$
        \end{itemize}
    \end{framedprop}
    ...
    \begin{frameddefn}{Grammatica $Fun_\tau$}
        ...
        \begin{itemize}
            \item due grammatiche per i \tit{tipi}, che verranno indicate genericamente con $Types$; la prima grammatica prende il nome di \tit{tipi primitivi}, mentre la seconda prende il nome di \tit{schemi di tipi};
            \item una grammatica per i \tit{termini}, che verrà indicata con $Terms$.
        \end{itemize}
    ...
    \begin{framedprop}{Regole di inferenza di $Fun_\tau$}
        ...
        \begin{itemize}
            \item \tbf{regola della generalizzazione}: \centeredeq{0.9}{$\forall M \in Terms, \sigma \in Types \quad \exists X \in TypeVar \mid X \notin \mathrm{free}(\Gamma) \implies [gen] \ \dfrac{\typejud{\Gamma}{M}{\sigma}}{\typejud{\Gamma}{M}{\forall X.\sigma}}$}
            \item \tbf{regola della specializzazione}: $$\forall M \in Terms, \sigma, \sigma' \in Types \quad \sigma > \sigma ' \implies \dfrac{\typejud{\Gamma}{M}{\sigma}}{\typejud{\Gamma}{M}{\sigma'}}$$
            \item TODO
        \end{itemize}
    \end{framedprop}
