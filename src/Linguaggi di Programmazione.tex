...
\begin{document}
    ...
    \begin{example}[Operatore $rec$ in $Fun_\rho$]
        Si consideri la grammatica $Fun_\rho$ descritta nella \cref{fun rho}, e sia $\funcmap{p_2}{\N}{\N}{n}{n + 2}$ la funzione che somma 2 all'input fornito; è possibile esprimerla attraverso l'operatore $rec$ come segue: $$p_2 : \soe{l}{p_2 \ 0 = 2 \\ p_2 \ (\succfn \ n)}$$ TODO DA FINIRE
    \end{example}
