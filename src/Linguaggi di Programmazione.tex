...
\begin{document}
    ...
    \begin{example}[Semantica operazionale di $Imp$]
        ...
        \begin{itemize}
            ...
            \item \tbf{esecuzioni sequenziali}: $$\forall p, q \in Imp, S_1, S_2 \in \mathrm{Store} \quad [seq] \ \dfrac{\opjudstore{E}{p}{ S}{S_1} \quad \opjudstore{E}{q}{ S_1}{S_2}}{\opjudstore{E}{p;q}{S}{S_2}}$$
            \item \tbf{if-then-else}: $$\forall p, q \in Imp, S_1 \in \mathrm{Store} \quad [ite_1] \ \dfrac{\opjudstore{E}{M}{ S}{true} \quad \opjudstore{E}{p}{S}{S_1}}{\opjudstore{E}{\ite{M}{p}{q}}{S}{S_1}}$$ $$\forall p, q \in Imp, S_2 \in \mathrm{Store} \quad [ite_2] \ \dfrac{\opjudstore{E}{M}{S}{false} \quad \opjudstore{E}{p}{S}{S_2}}{\opjudstore{E}{\ite{M}{p}{q}}{S}{S_2}}$$
            \item \tbf{while}: \centeredeq{0.9}{$\forall M \in Exp, S_1, S_2 \in \mathrm{Store} \quad [while_1] \ \dfrac{\opjudstore{E}{M}{S}{true} \quad \opjudstore{E}{p}{S}{S_1} \quad \opjudstore{E}{\while{M}{p}}{ S_1}{S_2}}{\opjudstore{E}{\while{M}{p}}{ S}{S_2}}$} $$\forall M \in Exp \quad [while_2] \ \dfrac{\opjudstore{E}{M}{S}{false}}{\opjudstore{E}{\while{M}{p}}{S}{S}}$$
            \item \tbf{dichiarazioni ed assegnazioni}: $$\forall x \in \mathrm{Var}, M \in Exp, p \in Imp, S_1 \in \mathrm{Store}, v \in \mathrm{Val} \quad \exists l \in \mathrm{Loc} \mid l \notin \dom(S) \implies$$ $$\implies [var] \ \dfrac{\opjudstore{E}{M}{S}{v} \quad \opjudstore{E\{(x,l)\}}{p}{S\{(l,v)\}}{S_1}}{\opjudstore{E}{\varin{x}{M}{p}}{S}{S_1}}$$
    ...
    \begin{example}
        ...
        \begin{itemize}
            ...
            \item \tbf{array}: $$\forall n \in \N, S_1 \in \mathrm{Store}, x \in \mathrm{Var}, M_0, \ldots, M_n \in Exp, p \in Imp, v_0, \ldots, v_n \in \mathrm{Val}$$ $$\exists (l_0, \ldots, l_n) \in \mathrm{Loc}^+ \mid l_0, \ldots, l_n \notin \dom(S) \implies$$ \centeredeq{0.9}{$\implies [arr] \ \dfrac{\opjudstore[M]{E}{M_0}{S}{v_0} \quad \ldots \quad \opjudstore[M]{E}{M_n}{S}{v_n} \quad \opjudstore[p]{E\{(x, (l_0, \ldots, l_n))\}}{p}{S\{(l_0, v_0), \ldots, (l_n, v_n)\}}{S_1}}{\opjudstore[p]{E}{\arrin{x}{[M_0, \ldots, M_n]}{p}}{S}{S_1}}$}
            \item \tbf{procedure}: $$\forall y,x \in \mathrm{Var}, p, q \in Imp, S_1 \in \mathrm{Store} \quad [proc] \ \dfrac{\opjudstore[p]{E\{(y,(x,p, E))\}}{q}{S}{S_1}}{\opjudstore[p]{E}{\procin{y}{x}{p}{q}}{S}{S_1}}$$
            \item \tbf{call-by-reference}: TODO
            \item \tbf{call-by-name}: TODO
        \end{itemize}
    \end{example}
