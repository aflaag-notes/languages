...
\begin{document}
    ...
    \begin{frameddefn}{Applicazione}
        ...
        Si noti che un'espressione $MNL$ applica prima $N$ ad $L$, e poi $M$ ad $NL$, dunque la precedenza è da destra verso sinistra, poiché equivale ad una composizione di funzioni.
    \end{frameddefn}
