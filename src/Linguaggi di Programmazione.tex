...
\begin{document}
    ...
    \begin{framedprop}{$Exp_\mathrm{LD}$}
        ...
        \begin{itemize}
            \item l'insieme degli ambienti di $Exp$ viene ridefinito come segue: $$\mathrm{Env} := \{f \mid \mathrm{Var} \xrightarrow{fin} \mathrm{Val} \cup Exp\}$$
            \item \tbf{valutazioni}: $$x \in \mathrm{Var} \quad x \in \dom(E) \land M := E(x) \implies \dfrac{\opjud{E}{M}{v}}{\opjud{E}{x}{v}}$$
    ...
    \begin{framedprop}[breakable]{$Exp_\mathrm{LS}$}
        ...
        \begin{itemize}
            \item l'insieme degli ambienti di $Exp$ viene ridefinito come segue: $$\mathrm{Env} := \{f \mid \mathrm{Var} \xrightarrow{fin} Exp \times \mathrm{Env} \}$$
            \item \tbf{valutazioni}: $$x \in \dom(E) \land (M, E') := E(x) \implies \dfrac{\opjud{E'}{M}{v}}{\opjud{E}{x}{v}}$$
    ...
    \begin{frameddefn}{Applicazione}
        La clausola di applicazione verrà utilizzata attraverso la sintassi $$\ttt{expression} \ \ttt{expression}$$
    ...
    \begin{framedprop}{$Fun_\mathrm{ED}$}
        ...
        \begin{itemize}
            ...
            \item l'insieme dei valori di $Fun$ viene ridefinito come segue: $$\mathrm{Val} := \{ \ttt 0, \ttt 1 , \ldots \} \cup (\mathrm{Var} \times Fun)$$                   \item \tbf{funzioni}: $$[fn] \ \opjud{E}{\fn{x}{M}}{(x,M)}$$
            \item \tbf{applicazioni}: $$[appl] \ \dfrac{\opjud{E}{\fn{x}{L}}{(x,L)} \quad \opjud{E}{N}{v'} \quad \opjud{E\{(x,v')\}}{L}{v}}{\opjud{E}{(\fn{x}{L})N}{v}}$$
        \end{itemize}
    \end{framedprop}
    ...
    \begin{framedprop}[breakable]{$Fun_\mathrm{ES}$}
        ...
        \begin{itemize}
            ...
            \item \tbf{applicazioni}: $$[appl] \ \dfrac{\opjud{E}{\fn{x}{L}}{(x, L, E')} \quad \opjud{E}{N}{v'} \quad \opjud{E'\{(x,v')\}}{L}{v}}{\opjud{E}{(\fn{x}{L})N}{v}}$$
        \end{itemize}
    \end{framedprop}
    ...
    \begin{framedprop}[breakable]{$Fun_\mathrm{LD}$}
        ...
        \begin{itemize}
            ...
            \item \tbf{applicazioni}: $$[appl] \ \dfrac{\opjud{E}{\fn{x}{L}}{(x,L)} \quad \opjud{E'\{(x,N)\}}{L}{v}}{\opjud{E}{(\fn{x}{L})N}{v}}$$
        \end{itemize}
    \end{framedprop}
    ...
    \begin{framedprop}{$Fun_\mathrm{LS}$}
        ...
        \begin{itemize}
            ...
            \item l'insieme dei valori di $Fun$ viene ridefinito come segue: $$\mathrm{Val} := \{\ttt 0, \ttt 1, \ldots\} \cup (\mathrm{Var} \times Fun \times \mathrm{Env})$$
            \item \tbf{funzioni}: $$\forall E \in \mathrm{Env}, x \in \mathrm{Var}, M \in Fun \quad \opjud{E}{\fn{x}{M}}{(x,M,E)}$$
            \item \tbf{applicazioni}: $$[appl] \ \dfrac{\opjud{E}{\fn{x}{L}}{(x,L,E')} \quad \opjud{E'\{(x,(N,E))\}}{L}{v}}{\opjud{E}{(\fn{x}{L})N}{v}}$$
        \end{itemize}
    \end{framedprop}
    ...
    \begin{frameddefn}{Clausola $assign$}
        La clausola $assign$ verrà utilizzata attraverso la sintassi $$\ttt{variable}  := \ttt{expression}$$ all'interno della quale, a \ttt{variable}, verrà assegnato il valore di \ttt{expression}.
    \end{frameddefn}
    ...
    \begin{framedprop}[label={imp sem},breakable]{Semantica operazionale di $Imp$}
        ...
        \begin{itemize}
            ...
            \item \tbf{if-then-else}: $$[ite_1] \ \dfrac{\opjudstore{E}{M}{ S}{true} \quad \opjudstore{E}{p}{S}{S'}}{\opjudstore{E}{\ite{M}{p}{q}}{S}{S'}}$$ $$[ite_2] \ \dfrac{\opjudstore{E}{M}{S}{false} \quad \opjudstore{E}{p}{S}{S''}}{\opjudstore{E}{\ite{M}{p}{q}}{S}{S''}}$$
    ...
    \begin{framedprop}[label={all r}]{$All_\mathrm{R}$}
        ...
        \begin{itemize}
            \item \tbf{call-by-reference}: $$\exists l \in \mathrm{Loc} - \dom(S) \land E(y) = (x, p, E') \implies$$ $$\implies [call]_{ref} \ \dfrac{\opjudstore[V]{E}{V}{S}{l} \quad \opjudstore[p]{E'\{(x,l)\}}{p}{S}{S'}}{\opjudstore[p]{E}{\call{y}{V}}{S}{S'}}$$
        \end{itemize}
    \end{framedprop}
