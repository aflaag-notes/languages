...
\begin{document}
    ...
    \begin{frameddefn}{Programma}
        Nel paradigma imperativo, un \tbf{programma} è un componente semantico che non restituisce valori --- dunque non ha \tit{side effect} --- ma cambiano il valore della \tbf{memoria}, ovvero un insieme arbitrario di elementi.
    \end{frameddefn}
    ...
    \begin{example}[Semantica operazionale di $Imp$]
        ...
        $$[const] \ \opjud{E}{k,S}{S}$$
        $$\forall x \in \mathrm{Var} \quad \exists v \in \mathrm{Var} \mid S(E(x)) = v \implies [vars] \ \opjud{E}{x,S}{v}$$
        \centeredeq{0.9}{$\forall M,N \in Exp, v \in \mathrm{Val} \quad \exists v_1, v_2 \in \mathrm{Val} \mid v = v_1 + v_2 \implies [plus] \ \dfrac{\opjud{E}{M,S}{v_1} \quad \opjud{E}{N,S}{v_2}}{\opjud{E}{M \ \ttt + \ N}{v}}$}
        \centeredeq{0.9}{$\forall M,N \in Exp, v \in \mathrm{Val} \quad \exists v_1, v_2 \in \mathrm{Val} \mid v = v_1 \cdot v_2 \implies [times] \ \dfrac{\opjud{E}{M,S}{v_1} \quad \opjud{E}{N,S}{v_2}}{\opjud{E}{M \ \ttt * \ N}{v}}$}
        $$\forall M, N \in Exp, v_1, v_2 \in \mathrm{Store} \quad v_1 < v_2 \implies [lt_1] \ \dfrac{\opjud{E}{M,S}{v_1} \quad \opjud{E}{N,S}{v_2}}{\opjud{E}{M \ \ttt < \ N,S}{true}}$$
        $$\forall M, N \in Exp, v_1, v_2 \in \mathrm{Store} \quad v_1 \ge v_2 \implies [lt_2] \ \dfrac{\opjud{E}{M,S}{v_1} \quad \opjud{E}{N,S}{v_2}}{\opjud{E}{M \ \ttt < \ N,S}{false}}$$
        $$[skip] \ \opjud{E}{skip,S}{S}$$
        $$\forall p, q \in Imp, S_1, S_2 \in \mathrm{Store} \quad [seq] \ \dfrac{\opjud{E}{p, S}{S_1} \quad \opjud{E}{q, S_1}{S_2}}{\opjud{E}{p;q,S}{S_2}}$$
        $$\forall p, q \in Imp, S_1 \in \mathrm{Store} \quad [ite_1] \ \dfrac{\opjud{E}{M, S}{true} \quad \opjud{E}{p,S}{S_1}}{\opjud{E}{\ite{M}{p}{q},S}{S_1}}$$
        $$\forall p, q \in Imp, S_2 \in \mathrm{Store} \quad [ite_2] \ \dfrac{\opjud{E}{M, S}{false} \quad \opjud{E}{p,S}{S_2}}{\opjud{E}{\ite{M}{p}{q},S}{S_2}}$$
        \centeredeq{0.9}{$\forall M \in Exp, S_1, S_2 \in \mathrm{Store} \quad [while_1] \ \dfrac{\opjud{E}{M,S}{true} \quad \opjud{E}{p,S}{S_1} \quad \opjud{E}{\while{M}{p}, S_1}{S_2}}{\opjud{E}{\while{M}{p, S}}{S_2}}$}
        $$\forall M \in Exp \quad [while_2] \ \dfrac{\opjud{E}{M,S}{false}}{\opjud{E}{\while{M}{p, S}}{S}}$$
        ...
        $$\implies [var] \ \dfrac{\opjud{E}{M,S}{v} \quad \opjud{E\{(x,l)\}}{p,S\{(l,v)\}}{S_1}}{\opjud{E}{\varin{x}{M}{p},S}{S_1}}$$
        $$\forall x \in \mathrm{Var}, M \in Exp \quad \exists l \in \mathrm{Loc} \mid E(x) = l \implies [assign] \ \dfrac{\opjud{E}{M,S}{v}}{\opjud{E}{x := M, S}{S\{(l, v)\}}}$$
    \end{example}
