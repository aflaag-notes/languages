...
\begin{document}
    ...
    \begin{framedthm}[label={robinson}]{Teorema di unificazione di Robinson}
        Esiste un algoritmo $\mathcal U$ \tit{fallibile} che, dati due tipi primitivi $\tau_1$ e $\tau_2$, restituisce una sostizuione $V$ tale che
        ...
        e tale che, se esiste un unificatore $W$ di $\tau_1$ e $\tau_2$, allora
